...
public class InvTweaksGuiTooltipButton extends InvTweaksGuiBaseButton {
     ...
     */
    public InvTweaksGuiTooltipButton(int x, int y, @NotNull String displayString_, String tooltip_) {
        this(x, y, InvTweaksGuiBaseButton.DEFAULT_WIDTH, InvTweaksGuiBaseButton.DEFAULT_HEIGHT, displayString_, tooltip_);
    }

    public InvTweaksGuiTooltipButton(int x, int y, @NotNull String displayString_, String tooltip_, @Nullable IPressable handler) {
        this(x, y, InvTweaksGuiBaseButton.DEFAULT_WIDTH, InvTweaksGuiBaseButton.DEFAULT_HEIGHT, displayString_, tooltip_, handler);
    }

    public InvTweaksGuiTooltipButton(int x, int y, int w, int h, @NotNull String displayString_, @Nullable String tooltip_) {
        this(x, y, w, h, displayString_, tooltip_, true, null);
    }

    public InvTweaksGuiTooltipButton(int x, int y, int w, int h, @NotNull String displayString_, @Nullable String tooltip_, @Nullable IPressable handler) {
        this(x, y, w, h, displayString_, tooltip_, true, handler);
    }

    public InvTweaksGuiTooltipButton(int x, int y, int w, int h, @NotNull String displayString_, @Nullable String tooltip_, boolean drawBackground_, @Nullable IPressable handler) {
        super(x, y, w, h, displayString_, handler);
        if(tooltip_ != null) {
            setTooltip(tooltip_);
        }
